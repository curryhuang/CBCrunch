...
public class Writables {
  ...
  private static final MapFn<Vector, VectorWritable> VC_TO_VCW = new MapFn<Vector, VectorWritable>(){
	@Override
  ...
  private static final MapFn<VectorWritable, Vector> VCW_TO_VC = new MapFn<VectorWritable, Vector>(){
	@Override
  ...
  private static final WritableType<ByteBuffer, BytesWritable> bytes = create(ByteBuffer.class, BytesWritable.class,
      BW_TO_BB, BB_TO_BW);
  private static final WritableType<Vector, VectorWritable> vectors = create(Vector.class, VectorWritable.class, VCW_TO_VC, VC_TO_VCW);
  ...
  public static final WritableType<Vector, VectorWritable> vectors(){
	  return vectors;
  }
