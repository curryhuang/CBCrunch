...
public class DoCollectionImplTest {
  ...
  static class ScaledFunction extends DoFn<String, String> {
    ...
    private float scaleFactorByRecord;
    
    public ScaledFunction(float scaleFactor){
    	this.scaleFactor = scaleFactor;
    	this.scaleFactorByRecord = 1.0f;
    }
    
    public ScaledFunction(float scaleFactor, float scaleFactorByRecord) {
      this.scaleFactor = scaleFactor;
      this.scaleFactorByRecord = scaleFactorByRecord;
    }
  ...
  static class SizedPCollectionImpl extends PCollectionImpl<String> {
    ...
    private long internalSizeByRecord;
