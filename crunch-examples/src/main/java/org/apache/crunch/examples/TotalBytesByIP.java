...
public class TotalBytesByIP extends Configured implements Tool, Serializable {
  ...
  public int run(String[] args) throws Exception {
    ...
    PCollection<String> lines1 = pipeline.readTextFile("src/main/resources/access_logs/input1");
    PCollection<String> lines2 = pipeline.readTextFile("src/main/resources/access_logs/input2");
    ...
    PTable<String, Long> ipAddrResponseSize1 = lines1
    ...
    PTable<String, Long> ipAddrResponseSize2 = lines2
            .parallelDo(extractIPResponseSize, Writables.tableOf(Writables.strings(), Writables.longs())).groupByKey()
            .combineValues(longSumCombiner);
    
    PTable<String, Long> ipAddrResponseSize = ipAddrResponseSize1.union(ipAddrResponseSize2).groupByKey().
    		combineValues(longSumCombiner);;
